...
L’objectif final est de comprendre **comment le climat influence la fréquentation touristique**  
et **les retombées économiques régionales**.
...
- `Dim_Dépenses_touristiques` : dépenses (en millions CHF)  
- `Calendar`, `Dim_Région_Typologie`, `Dim_Provenance`  
...
- Dashboard thématiques : Vue d’ensemble, Climat, Économie, Focus régional, Provenance  
...
- L’emploi touristique évolue en parallèle de la performance hôtelière  
